...
public class Ex08_main {
	public static void main(String[] args) {
		...
		/*
		 * Ex08 arr = new Ex08[4]; arr[0] = coffee; arr[1] = ion; arr[2] = cola; arr[3]
		 * = juice;
		 */
		...
		if (input < 1000) {
			...
			case "이온": output = input - arr[0].getPrice();	break;
			case "탄산": output = input - arr[0].getPrice();	break;
			case "과일": output = input - arr[0].getPrice();	break;
			}
